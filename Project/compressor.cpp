...
Compressor::Compressor() {
	...
	w2m8 = 0;
	h2m8 = 0;
	C = 4;//Compress rate - [1 Maximal - 8 Minimal]
	numberBitsShifted = 0;
}
...
// diy
void Compressor::modFunc(char* imagePath, char* savePath)
{
	//Just for information
	std::cout << "Compressing\n";

	std::cout << "Setting Parameter...\n";
	setParamCompression(imagePath);
